...
// Main Navbar Component - only the navigation elements, no background
export const LiquidGlassNavbar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 flex items-center justify-center px-8 py-6">
      <GlassFilter />

      {/* Center - Dock icons only */}
