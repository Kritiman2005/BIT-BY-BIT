...
const initialNotifications = [
  ...
  },
  {
    id: 5,
    image:
      "https://images.unsplash.com/photo-1517070213202-1ebbda816d2b?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
    user: "Sarah Chen",
    action: "commented on",
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button size="icon" variant="outline" className="relative bg-transparent" aria-label="Open notifications">
